...
<?php
	$solrurl = 'http://james.lis.soas.ac.uk:8983/solr/bib/select?fl=bibIdentifier&fq=DocType:item&fq=Language_search:Bengali&indent=on&q=*&rows=5000&wt=xml';
